function aiViolatingNodes = GetNodesViolatingPersistentActivation( tCommunicationsManager, fCurrentTime )
	%
	if( tCommunicationsManager.bForcePersistentActivationOfNodes )
		...
		aiViolatingNodes =												...
			(															...
				( fCurrentTime - tCommunicationsManager.afActivatingNodesTimers )	...
				>														...
