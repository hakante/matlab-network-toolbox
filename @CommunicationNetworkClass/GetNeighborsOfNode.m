% aiNeighbors = GetNeighborsOfNode( tNetwork, iNode, bUseSelfloops )
%
function aiNeighbors = GetNeighborsOfNode( tNetwork, iNode, bUseSelfloops )
	%
	% for readability
	aiAdjacencyRow = tNetwork.aaiAdjacencyMatrix(iNode, :);
	%
